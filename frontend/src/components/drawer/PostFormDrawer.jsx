...
// const PostFormDrawer = ({ open, setClose, children, label = "Label" }) => {
//   return (
//     <AnimatePresence>
//       {open && (
//         <motion.div
...
//             className="w-full max-w-6xl h-full flex"
//           >
//             <Button className="mt-7 btn-accent text-accent-content rounded-l-full">
